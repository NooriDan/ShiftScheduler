...
A command-line tool to generate optimized TA schedules by assigning lessons/labs/tut (shifts) to TAs, using Timefold. Try the new TABRIZ edition!

check out the [source code](/src/hello_world), if interested.
---
